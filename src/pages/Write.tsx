...
import userUpdatePostById from '../queries/useUpdatePostById';
...
const Write = () => {
    ...
    const { mutate: updatePost, isSuccess: isUpdateSuccess } = userUpdatePostById();
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div style={{ height: 'calc(100% - 4rem)', paddingBottom: '4rem' }}>
                ...
                <TagSelect value={tag} onChange={handleChangeTag}>
                    <option disabled selected>태그를 선택하세요</option>
                    {tagList.map(tag => (
